...
# Initialize Agent at module level (like successful Tokyo deployment)
logger.info("=" * 80)
...
if __name__ == "__main__":
    """Local testing only - AgentCore Runtime doesn't use this"""
    logger.info("=" * 80)
    logger.info("STARTING LOCAL TEST MODE")
    logger.info("=" * 80)
    app.run()
